...
export { Page } from "@shared/layout/Page";
export type {
  PageProps,
  PageHeaderProps,
  PageBodyProps,
...
export {
  ...
  useHeaderSlot,
  useHeaderSlotNode,
} from "@shared/layout/HeaderSlot";

// Admin shells — the section page (tab strip + Outlet) + the per-tab base.
export { AdminSectionPage } from "@shared/shared/admin/AdminSectionPage";
export { AdminTabShell, AdminAccessCard } from "@shared/shared/admin/AdminTabShell";
export type { AdminTabShellProps } from "@shared/shared/admin/AdminTabShell";
