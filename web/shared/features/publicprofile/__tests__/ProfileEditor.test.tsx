...
import { ProfileEditor } from "@shared/features/publicprofile/ProfileEditor";
...
import { PUBLIC_PROFILE_DEFAULT_LAYOUT } from "@shared/features/publicprofile/defaults";
...
describe("ProfileEditor — draft-save model", () => {
  ...
  it("dirty draft blocks navigation: useBlocker fires window.confirm; deny keeps user", async () => {
    ...
    const { NavAway } = await import("@shared/features/publicprofile/__tests__/_NavAway");
    renderWithProviders(
      <>
        <NavAway />
