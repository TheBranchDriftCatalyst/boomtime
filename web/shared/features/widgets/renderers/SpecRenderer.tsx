...
import { secondsToCompact, secondsToHms } from "@shared/lib/utils";
import {
  computeGrade,
  currentStreak,
  longestStreakInRange,
} from "@shared/features/publicprofile/grade";
import type {
  ResourceStats,
  PunchcardPayload,
  MomentumPayload,
...
import { specForKind, type SpecPanel } from "@shared/features/widgets/specs";
...
import { GoalProgress } from "@shared/features/widgets/renderers/GoalProgress";
import { GoalRing } from "@shared/features/widgets/renderers/GoalRing";
import { GoalList } from "@shared/features/widgets/renderers/GoalList";
