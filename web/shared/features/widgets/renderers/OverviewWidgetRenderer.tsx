...
import {
  ...
  useOverviewData,
} from "@shared/features/overview/OverviewDataContext";
import { buildRangeOverrideTr } from "@shared/features/overview/rangeOverride";
import {
  useOverviewStats,
  useOverviewTimeline,
...
import {
  SpecRenderer,
  type SpecRenderData,
} from "@shared/features/widgets/renderers/SpecRenderer";

export interface OverviewWidgetRendererProps {
  kind: string;
  view?: string;
  /** Opaque per-widget config (boom-lzr Phase 5's CONFIGURE form). This
