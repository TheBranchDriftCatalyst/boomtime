...
import { daysBetween } from "@shared/lib/utils";
import { bucketAvg, bucketDates, bucketGroups, bucketSum } from "@shared/viz/bucket";

/**
 * Shared ~weekly bucketing over a daily time-series range (see @shared/viz/bucket):
