// DashboardEditor (gaka-lzr, Phase 4 + Phase 5 + Phase 6) — the reusable edit
...
import { DraggableGridLayout, type WidgetInstance } from "@/lib/grid";
import {
  catalogForDashboard,
  widgetByKind,
  type DashboardScope,
...
import { OVERVIEW_DEFAULT_LAYOUT } from "@/features/overview/overviewDefaults";
import {
  add,
  moveResize,
  setConfig,
