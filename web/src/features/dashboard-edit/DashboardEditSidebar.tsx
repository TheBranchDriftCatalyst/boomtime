// DashboardEditSidebar (gaka-lzr, Phase 4 + Phase 5) — the edit rail.
...
//     kind (that's the larger gaka-5ox) — every kind gets the same four
...
import type { WidgetCatalogEntry } from "@/features/widgets/catalog";
...
/** The generic view/title/range/visibility form (gaka-lzr Phase 5). One
