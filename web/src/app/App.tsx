...
import { getRoutes } from "@/shared/routing/registry";
...
// route is pushed into @/shared/routing/registry by a domain's register module
...
// The host entry composes all three (see @/app/registerDomains); a standalone
